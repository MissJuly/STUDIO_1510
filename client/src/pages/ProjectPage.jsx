      ...
      <main className="flex-grow">
        <div className="max-w-3xl mx-auto px-6 py-16 animate-fadeIn">
          ...
          <p className="text-lg text-center mb-12 leading-loose">
            Ready to bring your vision to life? We’d love to hear about your project. Share your ideas, aspirations, and requirements — and our team will get in touch to explore how we can collaborate.
          </p>
